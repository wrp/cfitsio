...
\usepackage[pdfauthor={NASA HEASARC},colorlinks=true,bookmarksopen,pdfkeywords={Flexible Image Transport System},pdfpagelayout=OneColumn]{hyperref}
\usepackage{html}
\htmladdtonavigation
   {\begin{rawhtml}
...
of these programs can be compiled and linked by typing `make
